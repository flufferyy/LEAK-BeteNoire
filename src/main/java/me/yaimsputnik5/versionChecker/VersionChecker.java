package me.yaimsputnik5.versionChecker;
...
import me.yaimsputnik5.cope.gui.MessageWindow;
import me.yaimsputnik5.utils.Confirm;
...
public class VersionChecker {
    ...
    private final static String url = "https://api.github.com/repos/Yaimsputnik5/BeteNoire/releases/latest";
    ...
    private static void downloadNewVersion(String surl,String newVersionName) throws IOException {
        ...
        FileOutputStream fileOutputStream = new FileOutputStream("BêteNoire_" + newVersionName + ".jar");
